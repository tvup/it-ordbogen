...
- **Diskussion**: Åbn et issue hvis du er uenig i en eksisterende post
...
4. **Sæt status** til `proposed` på nye eller ændrede poster (eksisterende `approved`-poster bevarer status indtil panelet har godkendt ændringen)
